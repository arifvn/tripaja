...
class PopularListAdapter : RecyclerView.Adapter<PopularListAdapter.PostViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return PostViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_post_popular, parent, false)
        )
    }
