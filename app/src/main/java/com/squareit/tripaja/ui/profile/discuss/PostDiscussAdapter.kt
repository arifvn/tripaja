...
class PostDiscussAdapter : RecyclerView.Adapter<PostDiscussAdapter.PostViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return PostViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_post_discuss, parent, false)
        )
    }
